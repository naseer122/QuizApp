    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnNext.setOnClickListener {
                    ...
                    if (mCurrentPosition < mQuesitonList.size){
                        ...
                        var Intent = Intent(this@QuestionsActivity, ResultsScreen::class.java)
                        Intent.putExtra("name",name)
                        Intent.putExtra("correctAnsw",mCorrectAnswers)
                        Intent.putExtra("totalQues",mTotalQuestions)
                        startActivity(Intent)
                        finish()
                    }
                //Task You have Redesign the Result Screen For Practicing
                //Email, Apna Name
